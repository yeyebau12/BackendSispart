package com.proyecto.apartahotel.sispart.login.controller;
...
import com.proyecto.apartahotel.sispart.email.service.IEmailService;
...
import com.proyecto.apartahotel.sispart.login.dto.UsuarioEmpleadoDto;
...
public class UsuarioEmpleadoController {
	...
	public ResponseEntity<?> createLogin(@Valid @RequestBody UsuarioEmpleadoDto usuarioEmpleadoDto,
		...
		} else if (!usuarioEmpleadoDto.getContraseña().equals(usuarioEmpleadoDto.getConfirContraseña())) {
		...
		try {
			...
			String contraseña = passwordEncoder.encode(usuarioEmpleadoDto.getContraseña());
			String confirContraseña = passwordEncoder.encode(usuarioEmpleadoDto.getConfirContraseña());
		...
		try {
			...
			body = "\r\nUSERNAME: " + usuarioEmpleadoDto.getUserName() + "\nCONTRASEÑA:"
					+ usuarioEmpleadoDto.getContraseña() + "\r\n";
